...
const GrantCard: React.FC<GrantCardProps> = ({ grant, isSelected, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className={`
        relative w-[100%] h-[120px] rounded-2xl p-4 mb-3 cursor-pointer bg-white flex flex-row justify-between items-center
    ...
    >
      ...
      <div className="h-[70%] w-[55%] flex flex-row gap-3">
        <div className="relative group w-2 rounded-full" style={{ backgroundColor: grant.does_bcan_qualify ? "green" : "red" }}>
