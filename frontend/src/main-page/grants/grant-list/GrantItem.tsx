                ...
                <div className="flex justify-between">
                  ...
                  <div className="w-1/2">
                    ...
                    <div className="w-full justify-center">
                      ...
                      >
                        {curGrant.estimated_completion_time !== undefined
                  ...
                  <div className="w-1/2 h-full pl-5">
                    ...
                    <div
                      className="p-2 rounded-md h-52 w-4/5"
                      style={{
              ...
              <div className="w-1/2 ">
                ...
                <div className="flex w-full mb-4">
                  ...
                  <div className="w-full pr-3">
                    ...
                    >
                      <MdOutlinePerson2 className="w-12 h-full p-1" />
                      <div
                        style={{ backgroundColor: "#F2EBE4" }}
                        className="w-full border-l border-black bg-[#FFCEB6] rounded-r-md"
                      >
                        <h2
                          className="px-2 text-left font-bold h-10 w-full text-gray-700 rounded flex items-center"
                          id="grid-city"
                        >
                          {curGrant.bcan_poc?.POC_name ?? "Unknown"}
                        </h2>
                        <h2
                          className="px-2 text-left h-10 w-full text-gray-700 rounded flex items-center"
                          id="grid-city"
                        >
                ...
                <div className="flex justify-between">
                  ...
                  <div className="w-1/2 pr-3">
                    ...
                    <div className="w-full mb-3">
                      <label
                        className="text-md flex tracking-wide text-gray-700 font-bold mb-1  text-left"
                        htmlFor="grid-city"
                      >
                        Does BCAN qualify?
                      </label>
