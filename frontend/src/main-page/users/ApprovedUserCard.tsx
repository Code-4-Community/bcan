          ...
          <Menu.Positioner>
            <Menu.Content>
              <Button
                px={4}
                py={2}
                className="focus:outline-none block w-full bg-[#D3D3D3] border-[#666666] text-[#666666] mb-1"
              ...
              <Button
                px={4}
                py={2}
                className="focus:outline-none block w-full bg-[#FFDFDF] border-[#D33221] text-[#D33221]"
