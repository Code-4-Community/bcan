...
export const setActiveUsers = action("setActiveUsers", (users: User[]) => ({
  users,
}));
export const setInactiveUsers = action("setInactiveUsers", (users: User[]) => ({
  users,
}));
 ...
 */
export const appendGrant = action("appendGrant", (grant: Grant) => ({ grant }));
