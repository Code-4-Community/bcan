...
describe('AuthService', () => {
  ...
  describe('setNewPassword', () => {
    ...
    it('should successfully set new password', async () => {
      ...
      (service['cognito'] as any).respondToAuthChallenge = mockRespondToAuthChallenge;
  ...
  describe('updateProfile', () => {
    ...
    it('should handle DynamoDB update errors', async () => {
      ...
      await expect(
        service.updateProfile('c4c', 'c4c@example.com', 'Manager'),
